...
int main(int argc, const char* argv)
{
	...
	Shader defaultshader("Application/res/shaders/Backpack.shader");

	Shader visualizeNormals("Application/res/shaders/Visualize_normals/vertex.glsl",
						    "Application/res/shaders/Visualize_normals/fragment.glsl",
							"Application/res/shaders/Visualize_normals/geometry.glsl");
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		visualizeNormals.use();
		visualizeNormals.SetUniform("view", view);
		visualizeNormals.SetUniform("projection", projection);
		visualizeNormals.SetUniform("model", model);
		visualizeNormals.SetUniform("MAGNITUDE", (float)(sin(glfwGetTime()) + 1.0f) / 2.0f);
		BackPack.Draw(visualizeNormals);
